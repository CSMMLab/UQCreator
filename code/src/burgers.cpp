...
blaze::DynamicMatrix<double> Burgers::G( const blaze::DynamicMatrix<double>& u, const blaze::DynamicMatrix<double>& v ) { return F( u ); }

double Burgers::F( double u ) { return 0.5 * u * u; }

blaze::DynamicMatrix<double> Burgers::F( const blaze::DynamicMatrix<double>& u ) { return 0.5 * blaze::pow( u, 2 ); }
