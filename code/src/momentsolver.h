...
private:
    ...
    blaze::DynamicMatrix<double> numFlux(const blaze::DynamicMatrix<double> &lambda0, const blaze::DynamicMatrix<double>& lambda1, const blaze::DynamicMatrix<double>& lambda2, const blaze::DynamicMatrix<double> &lambda3);
