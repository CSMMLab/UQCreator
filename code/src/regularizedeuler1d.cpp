...
void RegularizedEuler1D::Gradient( Vector& g, const Matrix& lambda, const Matrix& u, unsigned refLevel ) {
...
void RegularizedEuler1D::GradientNoRegularizaton( Vector& g, const Matrix& lambda, const Matrix& u, unsigned refLevel ) {
    Vector uKinetic( _nStates, 0.0 );
    unsigned nTotal = _nTotalForRef[refLevel];
    g.reset();
...
void RegularizedEuler1D::Hessian( Matrix& H, const Matrix& lambda, unsigned refLevel ) {
    H.reset();
...
void RegularizedEuler1D::SolveClosure( Tensor& lambda, const Tensor& u, unsigned refLevel ) {
...
void RegularizedEuler1D::SolveClosureSafe( Tensor& lambda, const Tensor& u, unsigned refLevel ) { SolveClosure( lambda, u, refLevel ); }
