...
RegularizedExpEuler1D::RegularizedExpEuler1D( Settings* settings )
...
RegularizedExpEuler1D::~RegularizedExpEuler1D() {}

void RegularizedExpEuler1D::Gradient( Vector& g, const Matrix& lambda, const Matrix& u, unsigned nTotal, unsigned nQTotal ) {
...
void RegularizedExpEuler1D::GradientNoRegularization( Vector& g, const Matrix& lambda, const Matrix& u, unsigned nTotal, unsigned nQTotal ) {
    Vector uKinetic( _nStates, 0.0 );
    g.reset();
...
void RegularizedExpEuler1D::Hessian( Matrix& H, const Matrix& lambda, unsigned nTotal, unsigned nQTotal ) {
    H.reset();
...
void RegularizedExpEuler1D::SolveClosure( Matrix& lambda, const Matrix& u, unsigned nTotal, unsigned nQTotal ) {
