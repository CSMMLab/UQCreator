...
double Hermite::Evaluate( int m, double x ) { return boost::math::hermite( m, x ); }

const blaze::DynamicVector<double>& Hermite::GetNodes() { return _nodes; }

const blaze::DynamicVector<double>& Hermite::GetWeights() { return _weights; }
