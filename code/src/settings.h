...
class Settings
{
  private:
    ...
    std::vector<unsigned> _nTotalRefinementLevel;    // vector of number of moments in all dimensions for each refinement level
  ...
  public:
    ...
    std::vector<unsigned> GetNTotalRefinementLevel() const;
