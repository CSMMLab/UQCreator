...
\begin{itemize}
	\item It was not possible to obtain a result for sparse grids with moments of order 3 or higher. Any level up to level 11 ($72\;705$ quadrature nodes) of the used Clenshaw-Curtis sparse grids, resulted in a failure of the method during the computation of the mapping from the dual variables to the moment vector.
