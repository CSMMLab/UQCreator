...
\begin{align*}
\frac{\Vert E[\bm u_{\Delta}] - E[\mathcal{U}(\bm{\hat u}_{\Delta})] \Vert_{\Delta}}{\Vert E[\bm u_{\Delta}] \Vert_{\Delta}} \qquad \text{ and }\qquad \frac{\Vert Var[\bm u_{\Delta}] - Var[\mathcal{U}(\bm{\hat u}_{\Delta})] \Vert_{\Delta}}{\Vert Var[\bm u_{\Delta}] \Vert_{\Delta}}.
\end{align*}
...
\centering
	\begin{subfigure}{0.5\linewidth}
		\centering
				\includegraphics[scale=0.544]{figs/StudyQuadrature/L2_error_E[rho]_ipm.pdf}
		\caption{}
		\label{fig:ErrorDifferentQuadMeanIPM}
	\end{subfigure}%
	\begin{subfigure}{0.5\linewidth}
		\centering
				\includegraphics[scale=0.544]{figs/StudyQuadrature/L2_error_Var[rho]_ipm.pdf}
		\caption{}
		\label{fig:ErrorDifferentQuadVarIPM}
	\end{subfigure}
	\begin{subfigure}{0.5\linewidth}
		\centering
		\includegraphics[scale=0.544]{figs/StudyQuadrature/L2_error_E[rho]_mixed.pdf}
		\caption{}
		\label{fig:ErrorDifferentQuadMeanMixed}
	\end{subfigure}%
	\begin{subfigure}{0.5\linewidth}
		\centering
		\includegraphics[scale=0.544]{figs/StudyQuadrature/L2_error_Var[rho]_mixed.pdf}
		\caption{}
		\label{fig:ErrorDifferentQuadVarMixed}
	\end{subfigure}
	\caption{Relative L$^2$-error with different quadrature levels for solely IPM (Figure \ref{fig:ErrorDifferentQuadMeanIPM} and \ref{fig:ErrorDifferentQuadVarIPM}) and in comparison with SC (Figure \ref{fig:ErrorDifferentQuadMeanMixed} and \ref{fig:ErrorDifferentQuadVarMixed}). The subscript denotes the moment order, the superscript denotes the number of Clenshaw-Curtis quadrature points.}
...
\centering
	...
	\begin{subfigure}{0.5\linewidth}
		...
		\label{fig:sub2}
	\end{subfigure}
	\caption{Relative L$^2$-error with 5 MPI threads for density and energy.\frama{Eventuell diese Plots aufteilen? Oder sind die Ergebnisse verst\"andlich?}}
