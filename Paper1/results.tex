...
\centering
	...
	\end{subfigure}
	\caption{Reference solution E$[\rho]$ and Var$[\rho]$ and mesh used in the computation of all presented methods.}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.3\linewidth}
		...
		\label{fig:referenceSolutionsPipe2}
	\end{subfigure}
	\caption{Reference solution E$[\rho]$ and Var$[\rho]$ and used computational mesh.}
