...
\centering
	...
	\end{subfigure}
	\caption{Reference solution E$[\rho]$ and Var$[\rho]$. \comment{TODO: Error-Box (gestrichelt) hinzufügen}}
...
\begin{itemize}
\item The One-Shot one shot IPM (osIPM) method proposed in Section~\ref{sec:OneShotIPM} reduces the runtime while yielding the same error as the classical IPM method.
