...
\end{itemize}
The readosIPM results as well as the corresponding refinement levels are depicted in Figure~\ref{fig:readosIPMEVar}.
\begin{figure}[h!]
\centering
	\begin{subfigure}{0.33\linewidth}
		\centering
