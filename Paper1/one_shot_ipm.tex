...
In the following \comja{section we only consider steady...}, we look at steady state problems, i.e. we have
...
\end{align}
\end{subequations}
This gives algorithm \comja{yields Algotihm \ref{alg:osIPM}.}
\begin{algorithm}[H]
\begin{algorithmic}[1]
\For{$j=0$ to $N_x+1$}
...
\end{proof}
\comja{ca-IPM ist raus - remark streichen?}
\begin{remark}
